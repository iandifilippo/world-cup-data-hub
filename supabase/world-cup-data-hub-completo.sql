...
--
-- Se puede ejecutar varias veces: las inserciones usan ON CONFLICT DO NOTHING
-- y las vistas se sueltan antes de crearse.
-- =====================================================================
...
-- select count(*) from v_calendario_2026;                 -- 104
-- select count(*) from v_partidos_edicion where goles_local is not null; -- 215
-- select * from fn_auditar_rn03();                        -- sin filas
