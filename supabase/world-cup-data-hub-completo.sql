...
--
-- Une, en orden, las 8 migraciones de supabase/migrations/. Sirve para
...
-- =====================================================================
-- select count(*) from ediciones;                    -- 23 (22 + Mundial 2026)
-- select count(*) from equipos;                      -- 214 (211 FIFA + 3 históricas)
-- select count(*) from sedes;                        -- 79 (16 de 2026 + 63 históricas)
-- select count(*) from ranking_fifa where ciclo = 2026;  -- 211
-- select count(*) from v_calendario_2026;            -- 104
-- select count(*) from v_partidos_edicion where anio < 2026;  -- 111
-- select * from fn_auditar_rn03();                   -- sin filas = RN03 se cumple
-- select * from fn_comparar_ranking('COL');          -- RN10
